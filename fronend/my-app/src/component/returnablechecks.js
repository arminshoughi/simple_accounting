...
const Returnablechecks = () => {
  ...
  return (
    <div className="p-4">
      <h1>receivablechecks</h1>
      <div className="row">
        <div className="col-12 my-4">
          <div className="card">
            <div className="card-header">New receivablechecks</div>
              ...
              <ul className="list-group">
                <table className="w-full table-auto">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {data
                      .filter((i) => i.typ === "input")
                      .filter((i) => i.is_checked !== false)
                      .map((item) => (
...
export default Returnablechecks;

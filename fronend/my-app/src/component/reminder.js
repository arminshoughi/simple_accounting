...
const Reminder = () => {
  ...
  const [accountType, setAccountType] = useState("input");
  const [reminderType, setReminderType] = useState("check");
    ...
    <div className="p-4">
      ...
      <div className="row">
        <div className="col-12 my-4">
          <div className="card">
            <div className="card-header">New Reminder</div>
            <div className="card-body">
              <form onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-2 ml-10 mt-2">
                  ...
                  <div>
                    <label htmlFor="input">reminder type</label>
                    <div className="ml-3">

  ...
  return (
    <div className='p-4'>
      ...
      <div className='row'>
        ...
        />
      <label class="form-check-label" htmlFor="input">Input</label>
      </div>
      ...
      class="form-check-input"
        ...
        onChange={onOptionChange}
        />
      <label class="form-check-label" htmlFor="output">Output</label>  
        </div>
        </div>
        </div>
        <div>
        ...
        />
      <label class="form-check-label" htmlFor="input">true</label>
      </div>
      <div class="form-check">
      ...
      class="form-check-input"
        ...
        onChange={onOptionChangeChecked}
        />
      <label class="form-check-label" htmlFor="output">false</label>  
        </div>
        </div></div></div>  
